...
if (process.argv.length === 2) {
    ...
    try {
        ...
        console.log(chalk.cyan("\tNode"), chalk.white(config.explorerUrl));
        console.log(chalk.cyan("\tDepth"), chalk.white(config.explorerUrl));
        console.log(chalk.cyan("\tMWM"), chalk.white(config.explorerUrl));
        console.log(chalk.cyan("\tSeed"), chalk.white("*******"));
        console.log(chalk.cyan("\tAddress Index"), chalk.white(config.explorerUrl));
        console.log(chalk.cyan("\tTransaction Tag"), chalk.white(config.explorerUrl));
