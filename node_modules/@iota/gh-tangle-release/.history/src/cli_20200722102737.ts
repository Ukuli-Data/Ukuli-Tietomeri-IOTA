...
const version = "0.6.3";
console.log(chalk.green(`GitHub Tangle Release v${version}`));
...
program
    .usage("gh-tangle-release")
    .version(version, "-v, --version", "output the current version")
    .description("An application for creating a transaction on the IOTA Tangle from a GitHub release")
    .requiredOption("--github-token", "GitHub token for accessing your repository")
    .requiredOption("--owner", "GitHub repository owner")
    .requiredOption("--repository", "GitHub repository")
    .requiredOption("--release-tag", "The release tag from the GitHub repository")
    ...
    .option("--mwm <number>", "Minimum weight magnitude to use for attaching the transaction to the tangle",
        "14")
    .requiredOption("--seed", "81 Tryte seed used to generate addresses")
