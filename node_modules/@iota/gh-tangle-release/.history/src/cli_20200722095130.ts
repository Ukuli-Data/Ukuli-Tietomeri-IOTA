...
program
    ...
    .option("--release-tag-name", "The release tag from the GitHub repository")
...
const partialConfig: IPartialConfig = {
    ...
    owner: program["github-token"],
    repository: program["github-token"],
    releaseTag: program["github-token"],
    comment: program["github-token"]
};
