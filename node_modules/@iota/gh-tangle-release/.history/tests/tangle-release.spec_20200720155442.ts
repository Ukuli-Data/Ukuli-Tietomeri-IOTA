...
describe("Tangle Release", () => {
    ...
    test("No owner", async () => {
        ...
        expect(await tangleRelease(config)).toThrow("You must provide the owner setting");
    });
    ...
    test("No repository", async () => {
        ...
        expect(await tangleRelease(config)).toThrow("You must provide the repository setting");
    });
    ...
    test("No releaseTagName", async () => {
        ...
        expect(await tangleRelease(config)).toThrow("You must provide the releaseTagName setting");
    });
    ...
    test("No seed", async () => {
        ...
        expect(await tangleRelease(config)).toThrow("You must provide the seed setting");
    });
